...
searchForm.addEventListener('submit', fetchMovie); //fetch movie data from OMDB API

function fetchMovie(e) {
  e.preventDefault();
  var searchText = document.querySelector('#search-text').value;
  searchText.replace(' ', '+');
  var fetchUrl = "http://www.omdbapi.com/?i=tt3896198&apikey=3f6a0e17&s=".concat(searchText, "&type=movie&page=1");
...
function showMovie(movies) {
  ...
  for (var i = 0; i < movies.length; i++) {
    ...
    div.innerHTML = "    \n            <div class=\"card-body\">\n                <h3 class=\"card-header\">".concat(movie.Title, "</h3>\n                <ul class=\"list-group list-group-flush\">\n                    <li class=\"list-group-item\">Year:").concat(movie.Year, "</li>\n                    <li class=\"list-group-item\"><img src=\"").concat(movie.Poster, "\" width=\"300px\" height=\"400px\" /></li>\n                </ul>\n                <div class=\"footer\">\n                    <button class=\"btn btn-primary rounded-pill\" name=\"nomination\" id=\"card").concat(movie.imdbID, "\" value=\"").concat(movie.imdbID, "\" mname=\"").concat(movie.Title, "\">Nomination</button>\n                    <button class=\"btn btn-primary rounded-pill\" name=\"nomcancel\" value=\"").concat(movie.imdbID, "\">Cancel</button>\n                </div>\n            </div>\n            \n            ");
  ...
  document.getElementsByName("nomination").forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      if (list.childElementCount < 5) {
        ...
        li.innerHTML = "<li id=\"li".concat(e.target.value, "\" class=\"list-group-item d-flex justify-content-between align-items-center\">\n                            ").concat(e.target.attributes["mname"].value, "\n                            <button class=\"btn btn-primary rounded-pill\"  id=\"").concat(e.target.value, "\">Cancel</button>\n                        </li>");
        list.appendChild(li);
        e.target.disabled = true;
        document.getElementById(e.target.value).addEventListener('click', function (e) {
  ...
  document.getElementsByName("nomcancel").forEach(function (item) {
    item.addEventListener('click', function (e) {
      console.log(e.target.value);
